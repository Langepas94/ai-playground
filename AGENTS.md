...
- Если текущая ветка `dev` или `main`, для изменения кода или файлов проекта создай новую ветку.
- Если текущая ветка не `dev` и не `main`, продолжай работу в ней и не создавай отдельную ветку.
- Для сборки, тестов, диагностики, ревью и демо-прогонов без изменений работай в текущей ветке.
