...
- Web UI или JSON API сломаны: `src/web/README.md`, затем handler в `src/web/mod.rs` или специализированный helper (`src/web/agents.rs`, `tokens.rs`, `parameters.rs`). Web unit-тесты: `src/web/tests.rs`.
